//Program to illustrate the creation, executing and termination of processes with fork, exec and exit system calls.   
//TO DEMONSTRATE FORK(),EXIT(),GETPID(),GETPPID(),WAIT(),SLEEP(),EXECLP()
#include <unistd.h>
#include <stdio.h>
#include <stdlib.h>
#include <sys/types.h>
